pipeline {
    ...
    environment {
        VENV_DIR = 'venv'
        DOCKER_IMAGE = 'ashudurge/flask-api:latest'
        FLASK_APP_PORT = '5310'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/Ashwini2593/APIPython.git', branch: 'main'
            }
        }
        ...
        stage('Push Docker Image to Docker Hub') {
            steps {
                script {
                    ...
                    withCredentials([usernamePassword(credentialsId: 'ashudurge-hub', usernameVariable: 'DOCKER_HUB_USERNAME', passwordVariable: 'DOCKER_HUB_PASSWORD')]) {
